package com.zhjl.tech.ordersn.annotationdemo.atlog;
...
import com.zhjl.tech.ordersn.annotationdemo.ThreadLocalVar;
...
public class ZhijlLogAspect {
    ...
    @Pointcut("@annotation(com.zhjl.tech.ordersn.annotationdemo.atlog.ZhijlLog)")
    private void zjllog(){}//定义一个切入点

//    @Before("zjllog()&&@annotation(zhijlLog)")
//    public void doAccessCheck(ZhijlLog zhijlLog){
//        System.out.println("前置通知="+ zhijlLog.value() );
//    }
//
//    @AfterReturning("zjllog()")
//    public void doAfter(){
