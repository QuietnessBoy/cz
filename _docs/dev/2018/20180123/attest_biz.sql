...
-- Records of config
-- ----------------------------
INSERT INTO `config` VALUES ('2', '005', 'hash_cz_ok_url', 'http://127.0.0.1:8083/channelTest/hashCzOk', '2017-12-27 19:59:56.000000', '本地测试：文件Hash存证通知回调地址');
INSERT INTO `config` VALUES ('3', '005', 'xq_ok_url', 'http://127.0.0.1:8083/channelTest/CzXqOk', '2017-12-27 19:59:58.000000', '本地测试：文件存证续期通知回调地址');
INSERT INTO `config` VALUES ('4', 'zjl', 'ordersn_url', 'http://127.0.0.1:8084/ordersn/createOrdersn', '2017-12-27 20:00:18.000000', '知金链平台：请求订单号地址');
INSERT INTO `config` VALUES ('5', '003', 'cz_ok_url', 'http://cz.ipsebe.com/sebe/requestReceiveFinishCallback.do', '2017-12-27 20:00:46.000000', '杭州拾贝：文件存证通知回调地址');
INSERT INTO `config` VALUES ('6', '003', 'hash_cz_ok_url', 'http://cz.ipsebe.com/sebe/saveHashFileCallback.do', '2017-12-27 20:00:48.000000', '杭州拾贝：文件Hash存证通知回调地址');
INSERT INTO `config` VALUES ('7', '003', 'xq_ok_url', 'http://cz.ipsebe.com/sebe/extensionCallback.do', '2017-12-27 20:00:51.000000', '杭州拾贝：文件存证续期通知回调地址');
INSERT INTO `config` VALUES ('8', '004', 'cz_ok_url', 'http://47.94.229.222/EvidenceModule/Evidence/dealEvidenceEnd', '2017-12-27 20:01:00.000000', '存证网站：文件存证通知回调地址');
INSERT INTO `config` VALUES ('9', '004', 'hash_cz_ok_url', 'http://47.94.229.222/EvidenceModule/Evidence/dealHashEvidence', '2017-12-27 20:01:01.000000', '存证网站：文件Hash存证通知回调地址');
INSERT INTO `config` VALUES ('10', '004', 'xq_ok_url', 'http://47.94.229.222/EvidenceModule/Evidence/dealRenewalEvidence', '2017-12-27 20:01:03.000000', '存证网站：存证续期通知回调地址');
INSERT INTO `config` VALUES ('11', '005', 'cz_ok_url', 'http://127.0.0.1:8083/channelTest/fileCzOk', '2017-12-27 20:00:03.000000', '本地测试：文件存证完成回调地址');
INSERT INTO `config` VALUES ('13', 'zjl', 'query_cz_chained_url', 'http://172.17.94.222:3000/queryCzByOrdersn', '2017-12-27 20:00:23.000000', '知金链平台：查询存证上链接口');
INSERT INTO `config` VALUES ('14', 'zjl', 'add_cz_chained_url', 'http://172.17.94.222:3000/addCz', '2017-12-27 20:00:28.000000', '知金链平台：增加存证上链接口');
INSERT INTO `config` VALUES ('15', 'store_location', 'beijingOSS1', '放置一个json串{域名，accesskey键值对，oss存储空间}', '2017-11-16 20:07:27.000000', '说明');
...
-- Records of sequence
-- ----------------------------
INSERT INTO `sequence` VALUES ('ordersn', '0', '1', '2018-01-23');
...
CREATE TABLE `status` (
  ...
  `state_biz` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '订单当前状态',
  `state_notify` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '订单回调状态',
  `num` int(3) DEFAULT NULL COMMENT '异常次数记录',
  `remark` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_status_id` (`id`),
  UNIQUE KEY `idx_status_ordersn` (`ordersn`),
  KEY `idx_status_state` (`state_biz`),
