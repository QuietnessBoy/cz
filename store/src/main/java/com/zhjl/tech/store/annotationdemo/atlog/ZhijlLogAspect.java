package com.zhjl.tech.store.annotationdemo.atlog;
...
import com.zhjl.tech.store.annotationdemo.ThreadLocalVar;
...
public class ZhijlLogAspect {
    ...
    @Pointcut("@annotation(com.zhjl.tech.store.annotationdemo.atlog.ZhijlLog)")
