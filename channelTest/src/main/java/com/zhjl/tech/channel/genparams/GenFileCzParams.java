...
public class   GenFileCzParams {
    ...
    public String genUrlencodeMode(String path) throws IOException {
        ...
        AttestDto attestDto = genData(path,userid);
        if(attestDto ==null){
            return null;
        }
        ...
        sb = sb.append("signType=").append(URLEncoder.encode(attestDto.getSignType(),"UTF-8"))
               ...
               .append("&fileAddr=").append(URLEncoder.encode(attestDto.getFileAddr(),"UTF-8"))
    ...
    public String genPostmanMode(String path) throws IOException {
        ...
        StringBuilder sb = new StringBuilder();
        sb = sb.append("</br>").append("signType:").append(attestDto.getSignType()).append("</br>")
                ...
                .append("fileAddr:").append(attestDto.getFileAddr()).append("</br>")
                ...
                .append("price:").append(attestDto.getPrice()).append("</br>");
        log.info("@@@@@@@@@@@@@@{}",sb);
        return sb.toString();
    }
     ...
     * @throws IOException
     */
    public  AttestDto genData( String path,String userid){
        AttestDto attestDto = genFileCzDatas.gen(path,userid,"ordersn");
